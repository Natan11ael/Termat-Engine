...
namespace termat::gfx {
    ...
    namespace Font 
    {
        ...
        static const uint8_t Tiny5[][5] = {
            ...
            { 0x0E, 0x08, 0x08, 0x08, 0x0E }, // [     (91)
            { 0x10, 0x08, 0x04, 0x02, 0x01 }, // \     (92)
            { 0x0E, 0x02, 0x02, 0x02, 0x0E }, // ]     (93)
            { 0x04, 0x0A, 0x11, 0x00, 0x00 }, // ^     (94)
            { 0x00, 0x00, 0x00, 0x00, 0x1F }, // _     (95)
            { 0x04, 0x02, 0x00, 0x00, 0x00 }, // `     (96)
            { 0x00, 0x0E, 0x01, 0x0F, 0x0F }, // a     (97)
            { 0x10, 0x10, 0x1E, 0x11, 0x1E }, // b     (98)
            { 0x00, 0x0E, 0x10, 0x10, 0x0E }, // c     (99)
            { 0x01, 0x01, 0x0F, 0x11, 0x0F }, // d     (100)
            { 0x00, 0x0E, 0x1F, 0x10, 0x0E }, // e     (101)
            { 0x06, 0x08, 0x1E, 0x08, 0x08 }, // f     (102)
            { 0x00, 0x0F, 0x11, 0x0F, 0x01 }, // g     (103)
            { 0x10, 0x10, 0x1E, 0x11, 0x11 }, // h     (104)
            { 0x04, 0x00, 0x0C, 0x04, 0x0E }, // i     (105)
            { 0x02, 0x00, 0x02, 0x02, 0x1C }, // j     (106)
            { 0x10, 0x12, 0x1C, 0x12, 0x11 }, // k     (107)
            { 0x0C, 0x04, 0x04, 0x04, 0x0E }, // l     (108)
            { 0x00, 0x1A, 0x15, 0x15, 0x15 }, // m     (109)
            { 0x00, 0x1E, 0x11, 0x11, 0x11 }, // n     (110)
            { 0x00, 0x0E, 0x11, 0x11, 0x0E }, // o     (111)
            { 0x00, 0x1E, 0x11, 0x1E, 0x10 }, // p     (112)
            { 0x00, 0x0F, 0x11, 0x0F, 0x01 }, // q     (113)
            { 0x00, 0x16, 0x18, 0x10, 0x10 }, // r     (114)
            { 0x00, 0x0F, 0x1C, 0x03, 0x1E }, // s     (115)
            { 0x08, 0x1E, 0x08, 0x08, 0x06 }, // t     (116)
            { 0x00, 0x11, 0x11, 0x13, 0x0D }, // u     (117)
            { 0x00, 0x11, 0x11, 0x0A, 0x04 }, // v     (118)
            { 0x00, 0x11, 0x15, 0x1B, 0x11 }, // w     (119)
            { 0x00, 0x11, 0x0A, 0x04, 0x0A }, // x     (120)
            { 0x00, 0x11, 0x0F, 0x01, 0x0E }, // y     (121)
            { 0x00, 0x1F, 0x02, 0x04, 0x1F }, // z     (122)
            { 0x06, 0x08, 0x10, 0x08, 0x06 }, // {     (123)
            { 0x04, 0x04, 0x04, 0x04, 0x04 }, // |     (124)
            { 0x0C, 0x02, 0x01, 0x02, 0x0C }, // }     (125)
            { 0x08, 0x15, 0x02, 0x00, 0x00 }  // ~     (126)
        };
    }
    ...
    void Renderer2D::Char(int x, int y, wchar_t ch, int scale, short c, short col) {
        ...
        static constexpr int GLYPH_COUNT = 126 - 32 + 1;
        ScaledGlyph m_glyphCache[GLYPH_COUNT]{};
        ...
        if (glyph.data == nullptr || glyph.lastScale != scale) {
            ...
            glyph.data = new uint32_t[(size_t)(glyph.w * glyph.h)](); 
